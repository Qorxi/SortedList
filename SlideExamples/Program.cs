...
using SlideExamples.Collections;
...
namespace SlideExamples
{
    class Program
    {
        ...
        {
            global::SlideExamples.Collections.SortedList std = new global::SlideExamples.Collections.SortedList();
            std.Add(1, "c#");
            std.Add(12, "python");
            std.Add(8, "ruby");
            std.Add("t", 12);
...
** 
===========================================================*/
namespace SlideExamples.Collections
{
    using System;
    ...
    public class SortedList : IDictionary, ICloneable
    {
        ...
        public virtual void Add(Object key, Object value)
        {
            ...
            if (i >= 0)
                throw new ArgumentException("Argument_AddingDuplicate__" + GetKey(i) + " key : " + key);
            Insert(~i, key, value);
        }
        ...
        {
            if (index < 0 || index >= Count) throw new ArgumentOutOfRangeException("index", ("ArgumentOutOfRange_Index"));
            Contract.EndContractBlock();
            return keys[index];
        }
        ...
        private class SortedListEnumerator : IDictionaryEnumerator, ICloneable
        {
            ...
            {
                if (version != sortedList.version) throw new InvalidOperationException("ResId.InvalidOperation_EnumFailedVersion");
                index = startIndex;
                current = false;
                key = null;
                value = null;
        ...
        private class KeyList : IList
        {
            ...
            {
                throw new NotSupportedException(("ResId.NotSupported_SortedListNestedWrite"));
